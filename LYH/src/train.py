...
def main():
    ...
    model_path = '/home/leiyahui/code/DialMed-main/DialMed-main/data/chinese-roberta-wwm-ext'
    # data
    ...
    for epoch in range(args.epoch):
        ...
        model.train()
        for input_ids, token_type_ids, attention_mask, labels, adjs, cls_ids in tqdm(train_dataloader):
            ...
            outputs = model(input_ids, token_type_ids, attention_mask, adjs, cls_ids)
        ...
        if dev_dataloader:
            with torch.no_grad():
                ...
                for input_ids, token_type_ids, attention_mask, labels, adjs, cls_ids in tqdm(dev_dataloader):
    ...
    if test_dataloader:
        with torch.no_grad():
            ...
            for input_ids, token_type_ids, attention_mask, labels, adjs, cls_ids in tqdm(test_dataloader):
